...
from keras.layers import Input, Embedding, MultiHeadAttention, Dense, GlobalAvgPool1D, Conv1D, BatchNormalization, Activation, Dropout, LayerNormalization
...
class Trainer:
    ...
    def train_model(self):
        ...
        outputs = Dense(2, activation='softmax')(main_branch)
