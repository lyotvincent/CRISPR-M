...
class Trainer:
    ...
    def train_model(self):
        ...
        model.compile(optimizer=Adam(learning_rate=1e-3), loss=BinaryCrossentropy(), metrics=['acc', AUC(num_thresholds=4000, curve="ROC", name="auroc"), AUC(num_thresholds=4000, curve="PR", name="auprc")])
...
if __name__ == "__main__":
    ...
    for i in range(10):
        trainer.load_CIRCLE_dataset(encoding_method=encode_in_6_dimensions, sgRNA_type_index=i, out_dim=1)
