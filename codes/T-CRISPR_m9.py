...
class Trainer:
    ...
    def train_model(self):
        ...
        encoder_output = add_encoder_layer(encoder_output, num_heads=8, key_dim=6, units_dim=self.EMBED_SIZE, model_dim=self.EMBED_SIZE)
        ...
        decoder_output = add_decoder_layer(decoder_output, encoder_output, num_heads=8, key_dim=6, units_dim=self.EMBED_SIZE, model_dim=self.EMBED_SIZE)
