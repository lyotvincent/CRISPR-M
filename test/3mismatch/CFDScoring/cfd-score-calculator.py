...
if __name__ == '__main__':
    ...
    for i in range(2):
        ...
        fpr_list.append(result[11])
        tpr_list.append(result[12])
        precision_point_list.append(result[13])
        recall_point_list.append(result[14])
    print(fpr_list)
    # print(np.array(fpr_list).shape)
    ...
    with open("tpr.txt", "w") as f:
        for i in tpr_list:
            for j in i:
                f.write(str(j)+",")
            f.write("\n")
    with open("precision_point.txt", "w") as f:
        for i in precision_point_list:
            for j in i:
                f.write(str(j)+",")
            f.write("\n")
    with open("recall_point.txt", "w") as f:
        for i in recall_point_list:
            for j in i:
                f.write(str(j)+",")
            f.write("\n")
