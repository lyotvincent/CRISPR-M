...
if __name__ == "__main__":
    ...
    train_features_1, train_labels_1 = load_CIRCLE_dataset(encoding_method=encode_by_crispr_ip_method, out_dim=2)
    train_features_2, train_labels_2 = load_SITE(encoding_method=encode_by_crispr_ip_method, out_dim=2)
    val_features_1, val_labels_1 = load_I_2_dataset(encoding_method=encode_by_crispr_ip_method, out_dim=2)
    val_features_2, val_labels_2 = load_PKD(encoding_method=encode_by_crispr_ip_method, out_dim=2)
    val_features_3, val_labels_3 = load_GUIDE_II(encoding_method=encode_by_crispr_ip_method, out_dim=2)
    val_features_4, val_labels_4 = load_GUIDE_III(encoding_method=encode_by_crispr_ip_method, out_dim=2)
